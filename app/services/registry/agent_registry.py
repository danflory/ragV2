"""
Agent Registry: Formal catalog of available models with capability metadata.

This registry maps model identifiers to their performance characteristics,
...
class AgentRegistry:
    """
    Central registry of all available models across L1, L2, and L3 tiers.
    """
