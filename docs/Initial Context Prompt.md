...
I am building a high-performance RAG (Retrieval-Augmented Generation) system called **AntiGravity**. 
...
**Please acknowledge that you have read and understood the AntiGravity system specification before we begin.**
